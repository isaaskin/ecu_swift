...
//Control port pins
#define LCD_CONTROLPORT   PORTE   //port to send control signals (PC1-PC7)
#define LCD_CPDIRECTION   DDRE    //direction register for port to LCD control
...
#define LCD_DATAPORT      PORTD // MCU port connected to LCD data pins
#define LCD_DATA_IN	  PIND  // Place to read data in
#define LCD_DPDIRECTION   DDRD  // direction reg for data/command port data 1=out 0=in (A0)
